...
interface InvestorsTabProps {
  ...
  convertToExhibitor?: (investor: InvestorRegistration) => void;
}
                  ...
                  {role === "admin" && (
                    <div className="pt-2 border-t border-red-200 mt-2 space-y-2">
                       ...
                       {investor.status === "converted" && (
                         <button
                          onClick={() => {
                            if (window.confirm(`Are you sure you want to convert ${investor.full_name} to an Exhibitor?`)) {
                              convertToExhibitor?.(investor);
                            }
                          }}
